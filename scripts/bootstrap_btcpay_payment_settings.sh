...
BTCPAY_EXTERNAL_URL="$(trim_trailing_slash "${BTCPAY_EXTERNAL_URL:-}")"
if [[ -z "${BTCPAY_BASE_URL_TEST}" && -n "${BTCPAY_EXTERNAL_URL}" ]]; then
  BTCPAY_BASE_URL_TEST="${BTCPAY_EXTERNAL_URL}"
fi
if [[ -z "${BTCPAY_BASE_URL_LIVE}" && -n "${BTCPAY_EXTERNAL_URL}" ]]; then
  BTCPAY_BASE_URL_LIVE="${BTCPAY_EXTERNAL_URL}"
fi
...
BTCPAY_USDT_CURRENCY_CODE_TEST="${BTCPAY_USDT_CURRENCY_CODE_TEST:-USDT-TRON}"
BTCPAY_USDT_CURRENCY_CODE_LIVE="${BTCPAY_USDT_CURRENCY_CODE_LIVE:-USDT-TRON}"
